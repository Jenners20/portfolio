        ...
        <div>
            ...
            <main className={styles.main}>
                <div className={styles.description}>
                    ...
                    <p>He estado creando soluciones en la web durante los últimos 4 años para clientes de diversos paises e industrias.</p>
                    ...
                    <p>Experiencia</p>
                    <p>Tengo 4 años de experiencia trabajando con Node.js y React.</p>
                    <p>Tengo 3 años de experiencia trabajando con procesadores de pagos como CardNet y Stripe.</p>
